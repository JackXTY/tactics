...
{
    internal class CustomTerrainLitShaderGUI : UnityEditor.ShaderGUI, ITerrainLayerCustomUI
    {
        ...
        public CustomTerrainLitShaderGUI()
        {
        }
        ...
        // Rain Ground Effect
        MaterialProperty rainEffect = null;
        const string kRainEffect = "_RainEffect";
        ...
        static public void SetupMaterialKeywords(Material material)
        {
            ...
            bool enableRainEffect = material.GetFloat(kRainEffect) > 0.0f;
            CoreUtils.SetKeyword(material, "_RAIN_EFFECT", enableRainEffect);
        }
        ...
        public override void OnGUI(MaterialEditor materialEditorIn, MaterialProperty[] properties)
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                {
                    EditorGUI.indentLevel++;
                    materialEditorIn.ShaderProperty(rainEffect, styles.rainEffect);
                    EditorGUI.indentLevel--;
                }

                EditorGUILayout.Space();

                if (groundRainNormalTexture != null)
                {
                    EditorGUI.indentLevel++;
